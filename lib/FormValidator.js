...
var fromValidations = function fromValidations() {
  ...
  validations.forEach(function (validation) {
    if (Array.isArray(validation)) {
      ...
      Object.assign(obj, _defineProperty({}, name, validators[name](params)));
    } else {
      Object.assign(obj, _defineProperty({}, validation, validators[validation]));
    }
  });
  return obj;
};
...
var _input = _interopRequireDefault(__webpack_require__(2));
...
var _inputTypes = _interopRequireDefault(__webpack_require__(3));
...
Object.defineProperty(Input, "attrToType", {
  ...
  value: function value(type) {
    switch (type.toLowerCase()) {
      ...
      case 'email':
        return _inputTypes.default.MAIL;
